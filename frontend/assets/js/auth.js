...
function getNavigationPath(relativePath) {
    ...
    // Handle local development where 'frontend' might be in the path
    // If the current path contains '/frontend/', maintain it in the new path
    if (window.location.pathname.includes('/frontend/')) {
        return `${window.location.origin}/frontend/${cleanPath}`;
    }
